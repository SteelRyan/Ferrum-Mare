...
country = {
	...
	PROVINCE_OVERSEAS_PENALTY = 0.00, -- Each province req. this many goods flagged as overseas penalty 
	...
	INVESTMENT_SCORE_FACTOR = 0.004, -- how much foreign investment money counts towards your industry score
	...
	TECH_YEAR_SPAN = 140,
	TECH_FACTOR_VASSAL = 1, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 100,
...
military = {
	...
	POP_MIN_SIZE_FOR_REGIMENT_COLONY_MULTIPLIER = 3,
	...
	NAVAL_COMBAT_DAMAGE_STR_MULT = 0.2, -- scale the damage to ST1 for balancing gameplay
	NAVAL_COMBAT_DAMAGE_MULT_NO_ORG = 2.0, -- damage multiplier (to ST1) when opponent has no ORG.
	NAVAL_COMBAT_RETREAT_CHANCE = 0.07, -- base chance for retreating when ST1 or ORG is low. Increased by leader experiance and speed.
	NAVAL_COMBAT_RETREAT_STR_ORG_LEVEL = 0.15, -- the retreating is available when ST1 or ORG % drops below this value (it's 0% to 100% value)
	NAVAL_COMBAT_RETREAT_SPEED_MOD = 0.4, -- slow down when retreating so there is a chance to hit the runner
	NAVAL_COMBAT_RETREAT_MIN_DISTANCE = 0.5, -- how close (in average) all alive ships must be to the center line to be able to retreat.
	NAVAL_COMBAT_DAMAGED_TARGET_SELECTION = 2.5, -- multiply chance of seleting target that has low average of ST1/ORG
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 1.0, -- how little supply is acceptable before getting damage to ST1
	NAVAL_LOW_SUPPLY_DAMAGE_DAYS_DELAY = 10, -- delay in days before the ST1 will get damage due to no supplies. Sometimes supply status may jump bcoz of the market.
	NAVAL_LOW_SUPPLY_DAMAGE_MIN_STR = 1.0, -- when low supply, the navy will supply ST1 damage but no less then X% to avoid destruction (value from 0 to 100.0)
	NAVAL_LOW_SUPPLY_DAMAGE_PER_DAY = 2, -- damage to navies ST1 per day if totally 0% supplies (value from 0 to 100.0)
},
...
ai =
{
	...
	AGGRESSION_BASE = 0, -- general AI aggression
