...
military = {
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 1.0, -- how little supply is acceptable before getting damage to STR
	NAVAL_LOW_SUPPLY_DAMAGE_DAYS_DELAY = 10, -- delay in days before the STR will get damage due to no supplies. Sometimes supply status may jump bcoz of the market.
	...
	NAVAL_LOW_SUPPLY_DAMAGE_PER_DAY = 2, -- damage to navies STR per day if totally 0% supplies (value from 0 to 100.0)
},
